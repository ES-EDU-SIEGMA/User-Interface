...
class TestDataStorageGetMethods(unittest.TestCase):
    ...
    __configuration_ingredient_file_path: str = "test_ingredients.json"
    __configuration_recipe_file_path: str = "test_recipes.json"

    __data_storage_object: Json_data_module.DataStorage = Json_data_module.DataStorage(__configuration_ingredients,
    ...
    def test_get_ingredients_on_hopper_names(self):
        ...
        __received_result: list[str] = self.__data_storage_object.get_ingredient_on_hopper_names()

        self.assertEqual(__expected_result, __received_result)

    def test_get_recipe_dispensable_names(self):
        __expected_result: list[str] = ["test_recipe_2"]
        __received_result: list[str] = self.__data_storage_object.get_recipe_dispensable_names()
    ...
    def test_get_dispense_data(self):
        ...
        __received_result: dict = self.__data_storage_object.get_dispense_data("test_recipe_2")
...
class TestDataStorageSetMethod(unittest.TestCase):
    ...
    def test_set_hopper(self):
        ...
        __received_result_ingredient_on_hopper_names: list[
            str] = self.__data_storage_object.get_ingredient_on_hopper_names()

        __expected_result_dispensable_recipe_names: list[str] = []
        __received_result_dispensable_recipe_names: list[
            str] = self.__data_storage_object.get_recipe_dispensable_names()

        self.assertEqual(__expected_result_ingredient_on_hopper_names, __received_result_ingredient_on_hopper_names)
        self.assertEqual(__expected_result_dispensable_recipe_names, __received_result_dispensable_recipe_names)
...
class TestDataStorageCreateMethod(unittest.TestCase):
    ...
    def test_create_recipe(self):
        ...
        __expected_result_recipes: list[str] = ["test_recipe_1", "test_recipe_2", "test_recipe_3"]
        __received_result_recipes: list[str] = self.__data_storage_object.get_recipe_names()
