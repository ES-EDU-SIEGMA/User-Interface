...
class DataStorage:
    ...
    ####################################################################################################################
    # the following methods are used to return data to the class RuntimeData
    ####################################################################################################################
    ...
    def __create_beverage_as_list(self, __drink_id_str: str) -> list[str]:
        __result_beverage: list[str] = [
            self.__json_drink_dict[__drink_id_str]["id"],
            self.__json_drink_dict[__drink_id_str]["name"],
            self.__json_drink_dict[__drink_id_str]["hopper_id"],
            self.__json_drink_dict[__drink_id_str]["flow_speed"],
        ]
