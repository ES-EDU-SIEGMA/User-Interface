...
class DataStorage:
    ...
    def set_hopper(self, __hopper_position: int, __new_ingredient_on_hopper_name: str):
        ...
        # if __new_ingredient_on_hopper_name is None only the previous __previous_ingredient_on_hopper_name gets removed
    ...
    def create_recipe(self, __new_recipe_input: dict):
        ...
        for __recipe_name in __new_recipe_input:
            for __ingredient_name in __new_recipe_input[__recipe_name]:
                self.__recipes[__recipe_name][__ingredient_name]["fill_amount"] = \
                    __new_recipe_input[__recipe_name][__ingredient_name]["fill_amount"]
        self.__update_dispensable_recipe_names()
