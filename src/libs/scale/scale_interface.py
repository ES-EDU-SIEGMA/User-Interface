class Scale:
    ...
    def __init__(
        ...
        if __mock_scale:
            ...
            from libs.scale.scale_hardware.hx711_git_code import HX711 as HX711
            ...
            self.__scale_object = HX711(__calculation_method, __number_of_measurements)
